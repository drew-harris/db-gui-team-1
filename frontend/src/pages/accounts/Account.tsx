      ...
      <div>
        {displayRatings &&
          user.ratings.map((rating) => (
            <DisplayRating rating={rating} key={rating.id} />
          ))}
      </div>
    </div>
  );
    ...
    reviews: [
      {
        id: "1022",
        content:
          "Movie 1: words words words words words words words words words words words words words words words",
      ...
      },
      {
        id: "1023",
        content:
          "Movie 2: words words words words words words words words words words words words words words words",
      ...
      },
      {
        id: "1024",
        content:
          "Movie 3: words words words words words words words words words words words words words words words",
